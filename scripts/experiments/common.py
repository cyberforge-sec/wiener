...
def env_snapshot() -> dict:
    ...
    return {
        ...
        "WIENER_CLOUD_BASE_URL": config.CLOUD_BASE_URL,
        "WIENER_CLOUD_MODEL": config.CLOUD_MODEL,
        "WIENER_CLOUD_TEMPERATURE": config.CLOUD_TEMPERATURE,
        "WIENER_CLOUD_RESPONSE_FORMAT": config.CLOUD_RESPONSE_FORMAT,
        "WIENER_CLOUD_API_KEY_SET": bool(config.CLOUD_API_KEY),
